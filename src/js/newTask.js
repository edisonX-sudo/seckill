(function () {
  ...
  var html = "<div id=\"secKillForm\">\n" +
    ...
    "        <input type=\"datetime-local\"  class=\"secKill-input-text\" value=\"" + formatDateTime(new Date().getTime()) + formatTime(new Date().getTime()) + "\" step=\"1\" id=\"killTime\" name=\"killTime\">\n" +
    "    </div>\n" +
    "    <div class=\"secKill-filed\">\n" +
    "        <span class=\"secKill-name\">秒杀频率(ms):</span><br/>\n" +
    "        <input type=\"number\" name=\"frequency\"  class=\"secKill-input-number\"  id=\"frequency\"value=\"15\" min=\"10\" placeholder=\"单位：毫秒（ms）\"/>\n" +
    "    </div>\n" +
    "    <div class=\"secKill-filed\">\n" +
...
function formatTime(inputTime) {
  var date = new Date(inputTime + 20);
  var h = date.getHours();
  h = h < 10 ? ('0' + h) : h;
